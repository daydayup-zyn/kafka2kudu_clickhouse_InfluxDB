...
import com.zhbr.kafka2mysql.CommandResponse_Kafka2MySQL.{checkpoint_path, hdfs_checkpoint_path, properties}
...
object Datas_Kafka2MySQL {
  ...
  def main(args: Array[String]): Unit = {
    ...
    ssc.checkpoint(hdfs_checkpoint_path+"Datas_Kafka2MySQL")
